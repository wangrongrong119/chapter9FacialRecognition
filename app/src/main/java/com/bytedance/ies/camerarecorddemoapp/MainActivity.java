...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FaceDetectHelper.getHelper().setFaceDetectedCallback(new FaceDetectHelper.OnFaceDetectedCallback() {
            @Override
            public void onFaceDetected(final int ret,final  int top,final  int bottom,final int left,final int right) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        tv.setText(ret + "" +"上"+top+"下"+bottom+"左"+left+"右"+right);
//                        mEmotion.setImageURI();
                        if(ret==2){
                        mEmotion.setImageDrawable(getResources().getDrawable(R.drawable.eyeblink));
                        }
                        else if(ret==4){ mEmotion.setImageDrawable(getResources().getDrawable(R.drawable.mouthah)); }
                        else if(ret==8){ mEmotion.setImageDrawable(getResources().getDrawable(R.drawable.headyaw)); }
                        else if(ret==16){ mEmotion.setImageDrawable(getResources().getDrawable(R.drawable.headpic)); }
                        else if(ret==32){ mEmotion.setImageDrawable(getResources().getDrawable(R.drawable.browjump)); }
                        else if(ret==64){ mEmotion.setImageDrawable(getResources().getDrawable(R.drawable.mouthout)); }
    ...
    private void initView() {
        ...
        mCopyModeButton = findViewById(R.id.copy_model_btn);
         ...
         mEmotion = findViewById(R.id.faceimg);
